...
def preprocessing(df):
    ...
    df["Grade\nKualitas"] = encoder_grade.fit_transform(
        df["Grade\nKualitas"]
    )
...
def data_baru(
    ...
    panjang = float(input("Panjang Batang : "))
    diameter = float(input("Diameter Batang : "))
    kerapatan = float(input("Kerapatan : "))
    kadar_air = float(input("Kadar Air : "))
    musim = input("Musim Panen : ")
    pengeringan = int(input("Lama Pengeringan : "))
    ...
    print("\n===== HASIL PREDIKSI =====")
    print("Harga Jual :", round(harga))
    print("Grade      :", grade_asli)
